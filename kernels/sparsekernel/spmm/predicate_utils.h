#ifndef THIRD_PARTY_SPARSEKERNEL_SPMM_PREDICATE_UTILS_H_
#define THIRD_PARTY_SPARSEKERNEL_SPMM_PREDICATE_UTILS_H_
 ...
 */
template <int kPredicates, int kPredicatesPerByte = 4> class PredicateVector {
public:
...
#endif // THIRD_PARTY_SPARSEKERNEL_SPMM_PREDICATE_UTILS_H_
