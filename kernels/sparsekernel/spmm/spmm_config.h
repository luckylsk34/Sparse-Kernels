#ifndef THIRD_PARTY_SPARSEKERNEL_SPMM_SPMM_CONFIG_H_
#define THIRD_PARTY_SPARSEKERNEL_SPMM_SPMM_CONFIG_H_
...
#endif // THIRD_PARTY_SPARSEKERNEL_SPMM_SPMM_CONFIG_H_
