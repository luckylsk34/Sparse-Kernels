#ifndef THIRD_PARTY_SPARSEKERNEL_MATRIX_UTILS_H_
#define THIRD_PARTY_SPARSEKERNEL_MATRIX_UTILS_H_
...
#include "sparsekernel/test_utils.h"
...
template <typename Value> class CudaSparseMatrix;
...
protected:
  SparseMatrix()
      : values_(nullptr), row_offsets_(nullptr), column_indices_(nullptr),
...
template <typename Value> class CudaMatrix;
...
public:
   ...
   */
  template <typename Value> explicit Matrix(const CudaMatrix<Value> &matrix) {
...
#endif // THIRD_PARTY_SPARSEKERNEL_MATRIX_UTILS_H_
