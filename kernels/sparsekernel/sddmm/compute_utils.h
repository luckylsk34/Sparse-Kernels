#ifndef THIRD_PARTY_SPARSEKERNEL_SDDMM_COMPUTE_UTILS_H_
#define THIRD_PARTY_SPARSEKERNEL_SDDMM_COMPUTE_UTILS_H_
...
struct ComputeUtils {
  ...
  __device__ __forceinline__ ComputeUtils(const float *lhs_fragment_,
      ...
      : lhs_fragment(lhs_fragment_), rhs_fragment(rhs_fragment_),
...
#endif // THIRD_PARTY_SPARSEKERNEL_SDDMM_COMPUTE_UTILS_H_
