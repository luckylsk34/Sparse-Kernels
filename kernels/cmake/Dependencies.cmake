...
list(APPEND SPARSEKERNEL_LIBS "cudart_static;cublas_static;cusparse_static;culibos;cublasLt_static")

# Google Glog.
find_package(Glog REQUIRED)
list(APPEND SPARSEKERNEL_LIBS ${GLOG_LIBRARIES})
...
if (BUILD_TEST)
  ...
  list(APPEND SPARSEKERNEL_TEST_LIBS "gtest_main;gmock;absl::random_random")
endif()
...
if (BUILD_BENCHMARK)
  ...
  list(APPEND SPARSEKERNEL_BENCHMARK_LIBS "gtest;absl::random_random;benchmark::benchmark_main")
endif()
